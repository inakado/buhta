...
Актуализация 2026-06-07 выполнена после завершения polish-этапа `Остатки Директора` в активном плане frontend design system migration. Проверка была документационно-кодовой: активный plan, `DESIGN.md`, `docs/FRONTEND.md`, релевантные frontend-компоненты и CSS. Новый browser smoke в этот проход не выполнялся.
