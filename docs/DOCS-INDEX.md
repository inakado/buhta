...
- `docs/exec-plans/active/2026-05-30-distributor-sales.md` — активный план этапа Sales From Distributor: продажа с распределителя, списание товарного остатка и наличный баланс.
