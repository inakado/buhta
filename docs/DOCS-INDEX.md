...
- `docs/exec-plans/active/2026-06-23-net-weight-quantity-input.md` — draft-план ввода массы нетто для шаблонов продукции и переключателя `Масса, кг` / `Количество, шт` с сохранением штучного товарного учета и цены за единицу.
