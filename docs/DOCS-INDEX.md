...
- `docs/exec-plans/active/2026-05-30-distributor-inventory-read-model.md` — активный план этапа Distributor Inventory Read Model: read-only остатки и товарный баланс распределителя.
