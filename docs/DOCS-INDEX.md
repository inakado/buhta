...
- `docs/exec-plans/active/2026-06-07-frontend-design-system-migration.md` — активный план перехода frontend на новую Impeccable design system после extraction главной и остатков Директора: inventory экранов, ролевые варианты, порядок миграции и guardrails против смешивания старого и нового UI.
