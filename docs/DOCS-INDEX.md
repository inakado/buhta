...
- `docs/exec-plans/active/2026-06-11-production-deploy-cicd.md` — активный план первого production deploy и простого CI/CD-контура для Ubuntu + Docker Compose.
