...
const SUMMARY_BY_OPERATION_TYPE: Record<string, string> = {
	...
	"direct_accounting.sale.create": "Создание продажи прямого учета",
	"direct_accounting.sale.delete": "Удаление продажи прямого учета",
	"direct_accounting.sale.update": "Изменение продажи прямого учета",
	"direct_accounting.receipt.create": "Создание прихода прямого учета",
	"direct_accounting.receipt.delete": "Удаление прихода прямого учета",
	"direct_accounting.receipt.update": "Изменение прихода прямого учета",
	"direct_accounting.expense.create": "Создание затраты прямого учета",
	"direct_accounting.expense.delete": "Удаление затраты прямого учета",
	"direct_accounting.expense.update": "Изменение затраты прямого учета",
	"direct_accounting.transfer.create": "Создание передачи средств прямого учета",
	"direct_accounting.transfer.delete": "Удаление передачи средств прямого учета",
	"direct_accounting.transfer.update": "Изменение передачи средств прямого учета",
