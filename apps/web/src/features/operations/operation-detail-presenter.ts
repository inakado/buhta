...
const OPERATION_LABELS: Record<string, string> = {
	...
	"direct_accounting.expense.create": "Затрата прямого учета",
	"direct_accounting.expense.delete": "Удаление затраты прямого учета",
	"direct_accounting.expense.update": "Исправление затраты прямого учета",
...
const DETAIL_LABELS: Record<string, string> = {
	...
	spentOn: "Дата затраты",
	transferredOn: "Дата передачи",
