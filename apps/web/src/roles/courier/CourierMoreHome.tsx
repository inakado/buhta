...
export function CourierMoreHome({
	...
	return (
		<section className="screen-stack director-more-home">
			...
			<section className="director-more-section" aria-labelledby="courier-more-account">
				<h3 className="director-more-section-label" id="courier-more-account">Аккаунт</h3>
